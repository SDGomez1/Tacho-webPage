...
import { FriesMenu } from "@/assets/icons/FriesMenu";
export default function Navbar() {
  return (
    <div className="flex bg-white justify-between items-center w-full lg:mt-12 px-4 lg:px-16 py-2.5 2xl:pb-2 relative ">
